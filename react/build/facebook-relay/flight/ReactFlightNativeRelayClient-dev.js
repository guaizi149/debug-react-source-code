...
function initializeModuleChunk(chunk) {
  var value = ReactFlightNativeRelayClientIntegration.requireModule(chunk._value);
  var initializedChunk = chunk;
  initializedChunk._status = INITIALIZED;
  initializedChunk._value = value;
  return value;
...
function resolveModule(response, id, model) {
  ...
  var moduleReference = ReactFlightNativeRelayClientIntegration.resolveModuleReference(moduleMetaData); // TODO: Add an option to encode modules that are lazy loaded.
...
//# sourceMappingURL=ReactFlightNativeRelayClient-dev.js.map
