...
function initializeModuleChunk(chunk) {
  const value = ReactFlightNativeRelayClientIntegration.requireModule(chunk._value);
  const initializedChunk = chunk;
  initializedChunk._status = INITIALIZED;
  initializedChunk._value = value;
  return value;
...
function resolveModule(response, id, model) {
  ...
  const moduleReference = ReactFlightNativeRelayClientIntegration.resolveModuleReference(moduleMetaData); // TODO: Add an option to encode modules that are lazy loaded.
...
//# sourceMappingURL=ReactFlightNativeRelayClient-prod.js.map
