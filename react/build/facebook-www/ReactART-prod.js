...
/*             */
0b00000100000000000000000; // Static tags describe aspects of a fiber that are not specific to a render,
...
function restoreSpawnedCachePool(offscreenWorkInProgress, prevCachePool) {
  ...
  const nextParentCache =  CacheContext._currentValue2;
...
function performConcurrentWorkOnRoot(root, didTimeout) {
  ...
  let exitStatus = shouldTimeSlice(root, lanes) && (disableSchedulerTimeoutInWorkLoop || !didTimeout) ? renderRootConcurrent(root, lanes) : renderRootSync(root, lanes);
