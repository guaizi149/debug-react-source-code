...
function resolveModule(response, id, model) {
  ...
  const moduleReference = ReactFlightDOMRelayClientIntegration.resolveModuleReference(moduleMetaData); // TODO: Add an option to encode modules that are lazy loaded.
